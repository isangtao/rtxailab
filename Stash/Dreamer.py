...
if st.button("Generate"):
	...
	with st.spinner():
		...
		st.write("----------\n\nUsing the attached photos of the protagonist, generate 10 images that show the progression of the story above. Do not include text. Do not depict children. If you can't generate an image, skip that part of the story and generate the next image.  https://copilot.microsoft.com/ https://aistudio.google.com/")
